    ...
    class Program
    {
        class Chain
        {
            ...
            public void CompleteChain(object counter)
            {
                ...
                Random rnd = new Random();
                int chainLenght = rnd.Next(3, 10);
                char[] characters = new char[chainLenght];// chaincreator end
                ...
                while (true) // для бесконечного вывода строки
                {
                    ...
                    for (int i = 0; i <= Console.WindowHeight; i++)
                    {
                        ...
                        {
                            char character = (char)rnd.Next('A', 'z' + 1);
                        ...
                        //Thread.Sleep(500);
                        Monitor.Exit(block); // chainwriter end
